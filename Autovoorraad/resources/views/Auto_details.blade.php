        ...
        <div class="md:col-span-2">
            ...
            <div class="grid md:grid-cols-3 grid-rows-3 mt-10 md:grid-rows-1 gap-10">
                ...
                <div class="bg-white rounded-xl h-30 p-4 flex flex-col gap-2">
                    ...
                    <h3 class="text-xl font-bold tracking-tight font-serif">{{ $auto->km_stand ? number_format($auto->km_stand, 0, ',', '.') : 'N/A' }} <p class="text-[0.7rem] inline font-semibold tracking-widest font-sans text-[#2B4963]">km</p></h3>      
                    
                </div>
                <div class="bg-white rounded-xl h-30 p-4 flex flex-col gap-2">
                        <p class="text-[0.7rem] font-semibold uppercase tracking-widest font-sans text-[#2B4963]">Bouwjaar</p>
                        <h3 class="text-xl font-bold tracking-tight font-serif">{{ $auto->bouwjaar }}</h3>            
                </div>
        ...
        <div class="h-full flex flex-col w-full">
            <div class="bg-white h-full flex flex-col gap-4  w-full relative shadow rounded-2xl p-6">
                ...
                <div class="bg-yellow-400 p-1 rounded text-center">
                    <p class="text-md uppercase font-bold p-2">{{$auto->kenteken}}</p>
                </div>
            </div>
            <div class="bg-gray-100 shadow mt-10 p-6 h-full w-full rounded-2xl">
                ...
                <button x-on:click="status = 'foto_toevoegen'" class="p-4 cursor-pointer bg-white w-full mt-6 font-bold hover:bg-blaze-orange-100 flex rounded text-blaze-orange-600 gap-4 justify-between">
                        <div class="flex gap-4">
