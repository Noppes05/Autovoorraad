<x-app-layout>
    <div class="p-4 md:p-10" x-data="websiteSettings(@js($user))">
        ...
        <div class="p-2 md:p-4 bg-white rounded mb-4">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2  gap-10">
                    <div class="">
                        ...
                        <input hidden type="file" x-ref="logo" accept="image/*" tabindex="2" x-model="logo" class="outline-none w-min md:w-full placeholder:font-semibold">
                    </div>
                    <div class="">
                ...
                <div class="mb-8">
                        ...
                        <input hidden type="file" x-ref="hero" accept="image/*" tabindex="2" x-model="logo" class="outline-none w-min md:w-full placeholder:font-semibold">
                </div>
                <div class="mb-8">
